...
class CalculateROIPostRequestParams:
    ...
    def from_request(cls):
        ...
        parser.add_argument('hot_cold_level', required=True, type=float)
        args = parser.parse_args()
        return cls(
            roi_name=args['roi_name'],
            hot_cold_level=args['hot_cold_level']
        )
...
class CalculateROI(Resource):
    ...
    def get(self, mesh_name: str):
        ...
        path = ROI_DIR.absolute()/mesh_name/f'{params.roi_name}{suffix}.obj'
        if path.exists():
    ...
    def post(self, mesh_name: str):
        ...
        last_mesh_params = CalculateRoiMeshParams(
            ...
            hot_cold_level=body.hot_cold_level
        )
